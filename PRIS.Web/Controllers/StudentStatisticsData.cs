...
namespace PRIS.Web.Controllers
{
    ...
    {
        public static StudentEvaluationListViewModel PrepareData(string examId, string courseId, string cityId, string searchString, string sortOrder, ref List<Student> students)
        {
            ...
            var model = CourseMappings.ToViewModel(invitationToStudy);
        ...
        private static List<StudentEvaluationViewModel> CreateViewModelList(List<Student> students)
        {
            var invitationToStudy = new List<StudentEvaluationViewModel>();
            students.ForEach(x => invitationToStudy
                .Add(CourseMappings.ToViewModel(x, x.ConversationResult, x.StudentCourses, x.Result)));
        ...
        private static List<StudentEvaluationViewModel> SearchForStudents(string searchString, List<StudentEvaluationViewModel> invitationToStudy)
        {
